...
@WebServlet(urlPatterns = "/menu/people/show-all")
public class PersonShowAllServlet extends HttpServlet {
    @Override
    ...
    private void showMenu(
        ...
        try (PrintWriter writer = response.getWriter()) {
            writer.write("<html><head><title>People Show All</title></head><body>");
            if (people.size() == 0) {
